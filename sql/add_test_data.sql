...
INSERT INTO Muistiinpano (name, description, added, priority, kayt_id) VALUES ('Osta Kaljaa', 'kännit' ,NOW(), 'Tärkeä', 1);
INSERT INTO Muistiinpano (name, description, added, kayt_id) VALUES ('Osta mehua', 'mehu loppu' ,NOW(), 2);
INSERT INTO RyhmaMuistiinpano (name, description, added, kayt_id, ryh_id) VALUES ('Osta Ryhmälle mehua', 'mehu loppu' ,NOW(), 2, 1);